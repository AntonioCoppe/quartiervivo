import type { MetricDefinition, MetricGroup } from "../types/geography";
...
export const metrics: readonly MetricDefinition[] = [
  ...
  },
  {
    ...
    colorStops: [8000, 12000, 16000, 20000, 24000, 28000],
    description: {
      en: "MEF total declared income divided by ISTAT resident population where both are available.",
      it: "Reddito complessivo dichiarato MEF diviso per popolazione residente ISTAT dove entrambe le fonti sono disponibili."
    }
  },
  {
